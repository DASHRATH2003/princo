          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                printing services, L-mart platform, and local market services (collectively, the "Services") operated by L-Mart.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                L-Mart shall not be liable for any indirect, incidental, special, consequential, or punitive damages, 

          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-center group">
                ...
                <span className="group-hover:text-white transition">9880444189</span>
              </div>
              <div className="flex items-center group">
                <svg className="w-5 h-5 mr-2 group-hover:text-white transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="group-hover:text-white transition">info@printco.com</span>
              </div>
              <div className="flex items-center group">
                <svg className="w-5 h-5 mr-2 group-hover:text-white transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="group-hover:text-white transition">Mumbai, Maharashtra</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
              ...
              />
              <button className="bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition transform hover:scale-105">
                Subscribe
              </button>
            </div>
          </div>
